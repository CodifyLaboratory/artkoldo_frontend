    ...
    <div>
      ...
      <hr />
          <div className='page-content'>
            ...
            <div><img className='product-img' src={product.photo_1} alt={product.name}>
            </img>
            </div>
            <div className="four_photos">
            <img className='img_box' src={product.photo_1} alt={product.name}></img>
            <img className='img_box' src={product.photo_1} alt={product.name}></img>
            <img className='img_box' src={product.photo_1} alt={product.name}></img>
            <img className='img_box' src={product.photo_1} alt={product.name}></img>
            </div>
            <div>
              ...
              <h2 className="small_heading">Общие</h2>
                  ...
                  <span className="description">Оплата и доставка производится.......... </span>
                  <hr  className="dividing_line"></hr>
                </div>
            </div>
         <div class="right_side">
            <div class="right_description_headings">{product.title}
            </div>
        ...
        <Link to={'/basket'} button className="add_btn"  onClick={() => onAdd(product)}>Добавить в корзину</Link>
      </div>
          </div>
          </div>
